...
class CreateFacilityUseCase @Inject constructor(
    ...
    suspend operator fun invoke(createFacilityRequest: CreateFacilityRequest): Flow<ResultState<FacilityResponse>> {
        return facilityRepository.createFacility(createFacilityRequest = createFacilityRequest)
    }
}
